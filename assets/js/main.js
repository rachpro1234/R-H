...
const iconTheme = 'fa-sharp fa-light fa-sun-bright'
...
const getCurrentIcon = () => themeButton.classList.contains(iconTheme) ? 'fa-regular fa-moon' : 'fa-sharp fa-light fa-sun-bright'
